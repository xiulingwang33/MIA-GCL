...
from GCL2.losses import Loss
from GCL2.models import get_sampler
...
class DualBranchContrast_mia(torch.nn.Module):
    def __init__(self, loss: Loss, mode: str, intraview_negs: bool = False, **kwargs):
        super(DualBranchContrast_mia, self).__init__()
        self.loss = loss
        self.mode = mode
        self.sampler = get_sampler(mode, intraview_negs=intraview_negs)
        self.kwargs = kwargs
    ...
    def forward(self, h1=None, h2=None, g1=None, g2=None, batch=None, h3=None, h4=None,
        ...
        return (l1.mean() + l2.mean()) * 0.5,l1,l2
